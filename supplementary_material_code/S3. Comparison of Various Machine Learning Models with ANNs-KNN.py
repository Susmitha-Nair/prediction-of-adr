...
def compute_accuracy(train_set, train_adr):
    clf = classifier = KNeighborsClassifier(n_neighbors=25)
...
if __name__ == "__main__":
    base_path = '/sas/vidhya/susmitha/ADR_Prediction/final_results/KNN/pca/subset_1/' # 'C:\\Users\\Aditya R\\Downloads\\'
    ...
    chunks = list(divide_chunks(adrs_all,20))
